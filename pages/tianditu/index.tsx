    ...
    return (
      <>
        ...
        <div className={style['handle-box']}>
          <button type="button" onClick={this.add.bind(this, 'TILEROW')}>
            row add
          </button>
          <div className={style['handle-box-col']}>
            <button type="button" onClick={this.add.bind(this, 'TILECOL')}>
              col add
            </button>
            <button type="button" onClick={this.reduce.bind(this, 'TILECOL')}>
              col reduce
            </button>
          </div>
          <button type="button" onClick={this.reduce.bind(this, 'TILEROW')}>
            row reduce
          </button>
        </div>
      </>
